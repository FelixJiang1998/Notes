...
public class ShowTextList extends Activity {
    ...
    private Button btnAddNewText, btnAllNote, btnSearch, btnAddNewVideo, btnAddNewVoice, btnReturn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(ShowTextList.this, "您进入了文本记录列表", Toast.LENGTH_SHORT).show();
        ...
        btnAddNewText = (Button) this.findViewById(R.id.btnAddNewText1);
        btnSearch = (Button) this.findViewById(R.id.btnSearch1);
        btnAllNote = (Button) this.findViewById(R.id.btnAll1);
        btnAddNewVoice = (Button) this.findViewById(R.id.btnAddNewVoice1);
        btnAddNewVideo = (Button) this.findViewById(R.id.btnAddNewVideo1);
        btnReturn = (Button) this.findViewById(R.id.btnReturn1);
        ...
        //关键字查询搜索的文本输入框
        txtBlur = (EditText) this.findViewById(R.id.search_Content1);

        listview = (ListView) findViewById(R.id.listview1);

        connect = new SqliteDBConnect(ShowTextList.this);
        ...
        listview.setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
                ...
                AlertDialog.Builder adb = new Builder(ShowTextList.this);
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                switch (which) {
                                    case 0:
                                        ...
                                        Toast.makeText(ShowTextList.this, "删除成功", Toast.LENGTH_SHORT).show();
                                        sdb.close();
                                        disPlay();
                                        break;
                                    case 1:
    ...
    public void disPlay() {
        ...
        sdb.close();
        if (count > 0) {
            adapter = new SimpleAdapter(ShowTextList.this, list, R.layout.text_item,
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            Intent intent = new Intent(ShowTextList.this, MainUIActivity.class);
            overridePendingTransition(R.anim.left_in, R.anim.left_out);
            startActivity(intent);
            finish();
        }
    ...
    class ButtonClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.btnAddNewText1) {
                ...
                startActivity(intent);
                finish();
            } else if (v.getId() == R.id.btnAddNewVoice1) {
                Intent intent = new Intent();
                intent.setClass(ShowTextList.this, AddNewVoice.class);
                overridePendingTransition(R.anim.left_in, R.anim.left_out);
                startActivity(intent);
                finish();
            } else if (v.getId() == R.id.btnAddNewVideo1) {
                Toast.makeText(ShowTextList.this, "由于时间有限暂未完成该模块", Toast.LENGTH_LONG).show();
            }
            //搜索按钮的事件处理
